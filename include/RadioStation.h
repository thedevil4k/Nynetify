...
inline std::vector<RadioStation> bundled_stations = {
    ...
    {20, "Loca FM Urban",         "https://s1.we4stream.com:2020/stream/locaurban",             "Urban",       "ES", "Spain", "MP3", 192},
    // ── Spain — Other ──
    ...
    {25, "Flaix FM",             "https://mdstrm.com/audio/68c1884bb3496b77f5d86c1c/icecast.audio?property=flaixfmApp", "Dance", "ES", "Spain", "MP3", 128},
