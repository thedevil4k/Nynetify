...
namespace Theme {
    ...
    const Fl_Color ACCENT = fl_rgb_color(30, 215, 96);       // Slightly brighter Spotify Green
    ...
    const Fl_Color CARD_BG = fl_rgb_color(24, 24, 24);       // Spotify card background
    const Fl_Color FAVORITE_YELLOW = fl_rgb_color(255, 215, 0); // Gold

    const int BORDER_RADIUS = 10; // Slightly more rounded
